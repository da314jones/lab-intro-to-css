describe("Styling", () => {
  ...
  it("Font weights in ordered lists is bold", () => {
    cy.get("ol").should("have.css", "font-weight", "700");
  });
  it("List items are centered", () => {
    cy.get("li").should("have.css", "text-align", "center");
  });
  it("List items have a 1px purple boarder with curved corners", () => {
    cy.get("li")
      .should("have.css", "border", "1px solid rgb(128, 0, 128)")
      .and("have.css", "border-radius", "10px");
  });
  it("List items have a rebeccapurple font with a thistle background color", () => {
    cy.get("li")
      .should("have.css", "color", "rgb(102, 51, 153)")
      .and("have.css", "background-color", "rgb(216, 191, 216)");
  });
  ...
  it("h3s are underlined", () => {
    cy.get("h3").should("have.css", "text-decoration-line", "underline");
  });
  ...
  it("List items have 30 px of padding on the left", () => {
    cy.get("li").should("have.css", "padding-left", "30px");
  });
  it("Has a background color", () => {
    cy.get("html").should("not.have.css", "background-color", "transparent");
  });
});
